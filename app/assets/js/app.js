...
const State = {
    ...
    /** @type {'first'|'last'} whether custom expressions appear first or last in SELECT */
    selectCustomExprsOrder: 'first',
...
const App = (() => {
    ...
    function _getRightPaneSnapshot() {
        return {
            ...
            selectCustomExprsOrder: State.selectCustomExprsOrder ?? 'first',
    ...
    function _applyRightPaneSnapshot(snap) {
        ...
        Object.assign(State, {
            ...
            selectCustomExprsOrder: snap.selectCustomExprsOrder ?? 'first',
    ...
    function _mergeIslandConfigs(sourceKeys, targetKey) {
        ...
        State.islandConfigs[targetKey] = {
            ...
            selectCustomExprsOrder: sources[0].selectCustomExprsOrder ?? 'first',
    ...
    function _splitIslandConfig(sourceKey, targetKeys, allIslands) {
        ...
        targetKeys.forEach(targetKey => {
            ...
            State.islandConfigs[targetKey] = {
                ...
                selectCustomExprsOrder: State.islandConfigs[targetKey]?.selectCustomExprsOrder ?? source.selectCustomExprsOrder ?? 'first',
    ...
    function applyContext(json, contextName = '', opts = {}) {
        try {
            ...
            Object.assign(State, {
                ...
                savedTimelineGroups: Array.isArray(parsed.savedTimelineGroups) ? parsed.savedTimelineGroups : [],
            });
